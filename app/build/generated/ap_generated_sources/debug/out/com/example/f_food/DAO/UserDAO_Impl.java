  ...
  public UserDAO_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `Users` (`UserID`,`FullName`,`Email`,`Password`,`Phone`,`UserType`,`CreatedAt`,`UpdatedAt`) VALUES (nullif(?, 0),?,?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfUser = new EntityDeletionOrUpdateAdapter<User>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `Users` SET `UserID` = ?,`FullName` = ?,`Email` = ?,`Password` = ?,`Phone` = ?,`UserType` = ?,`CreatedAt` = ?,`UpdatedAt` = ? WHERE `UserID` = ?";
      }
